## Project 3 - TwitterLite: Twitter for Dummies :-)

**TwitterLite** is an android app that allows a user to view home and mentions timelines, view user profiles with user timelines, as well as compose and post a new tweet. The app utilizes [Twitter REST API](https://dev.twitter.com/rest/public). Meant for a user who wants Twitter but doesn't need all of the functionality. :-)
...
* [x] Used Glide instead of Picasso and implemented rounded corners.

## Video Walkthrough

Here's a walkthrough of implemented user stories:

<img src='http://i.imgur.com/3qqbRHe.gif?1' title='Video Walkthrough' width='' alt='Video Walkthrough' />
